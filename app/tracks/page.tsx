...
import { deleteCircuit, toggleFavoriteCircuit } from "./actions"
          ...
          filteredCircuits.map((circuit) => (
            ...
            >
              ...
              {circuit.map_image_url && (
                <div className="w-full h-32 relative bg-slate-50 dark:bg-slate-950 border-b dark:border-slate-800">
                  <Image 
                  ...
                  <button 
                    ...
                    className="absolute top-2 right-2 p-1.5 rounded-full bg-white/80 dark:bg-black/50 hover:scale-110 transition-transform shadow-sm backdrop-blur-sm"
                  >
                    <Star 
                      size={18} 
